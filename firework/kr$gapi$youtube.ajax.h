	...
	namespace gapi
	{
		namespace youtube
		{
			...
			namespace liveBroadcast
			{
				...
				{
					kr::AText /** youtube#liveBroadcast */ kind;
					kr::AText /** etag */ etag;
					kr::AText id;
					struct snippet_t
					{
						kr::AText /** datetime */ publishedAt;
						kr::AText channelId;
						kr::AText title;
						...
						kr::AText /** datetime */ scheduledStartTime;
						kr::AText /** datetime */ scheduledEndTime;
						kr::AText /** datetime */ actualStartTime;
						kr::AText /** datetime */ actualEndTime;
					...
					struct contentDetails_t
					{
						...
						kr::AText /** datetime */ boundStreamLastUpdateTimeMs;
				...
				{
					kr::AText /** youtube#liveBroadcastListResponse */ kind;
					kr::AText /** etag */ etag;
			...
			namespace liveChatMessage
			{
				struct Resource : __format_base
				{
					kr::AText /** youtube#liveChatMessage */ kind;
					kr::AText /** etag */ etag;
					kr::AText id;
					struct snippet_t
					{
				...
				struct List : __format_base
				{
					kr::AText /** youtube#liveChatMessageListResponse */ kind;
					kr::AText /** etag */ etag;
					kr::AText nextPageToken;
					uint pollingIntervalMillis = 0;
					kr::AText /** datetime */ offlineAt;
					struct pageInfo_t
					{
						int totalResults = 0;
						int resultsPerPage = 0;
			...
			namespace search
			{
				struct Resource : __format_base
				{
					kr::AText /** youtube#searchResult */ kind;
					kr::AText /** etag */ etag;
					struct id_t
					{
						kr::AText kind;
				...
				struct List : __format_base
				{
					kr::AText /** youtube#searchListResponse */ kind;
					kr::AText /** etag */ etag;
					kr::AText nextPageToken;
					kr::AText prevPageToken;
					struct pageInfo_t
			...
			namespace video
			{
				struct Resource : __format_base
				{
					kr::AText /** youtube#video */ kind;
					kr::AText /** etag */ etag;
					kr::AText id;
					struct liveStreamingDetails_t
					{
						kr::AText activeLiveChatId;
						void parseJson(JsonParser & parser)
						{
							parser.fields([this](JsonField& field)
							{
								field("activeLiveChatId", &activeLiveChatId);
							}
							);
						}
					};
					liveStreamingDetails_t liveStreamingDetails;
					struct snippet_t
					{
						kr::AText /** datetime */ publishedAt;
						kr::AText channelId;
					...
					struct recordingDetails_t
					{
						...
						location_t location;
						kr::AText /** datetime */ recordingDate;
						void parseJson(JsonParser & parser)
						{
							parser.fields([this](JsonField& field)
							{
					...
					void parseJson(JsonParser & parser)
					{
						parser.fields([this](JsonField& field)
						{
							...
							field("etag", &etag);
							field("id", &id);
							field("liveStreamingDetails", &liveStreamingDetails);
							field("snippet", &snippet);
							field("contentDetails", &contentDetails);
							field("status", &status);
							field("statistics", &statistics);
				...
				struct List : __format_base
				{
					kr::AText /** youtube#videoListResponse */ kind;
					kr::AText /** etag */ etag;
					kr::AText nextPageToken;
					kr::AText prevPageToken;
					struct pageInfo_t
